...
load("./blob/prbs_latest.mat");

%% Print PRBS parameters
disp("MLBS parameters:");
...
% %% ZOH circuit sampling compensation
...
hold("on"), plot(real(zv_ref), imag(zv_ref), "LineStyle", "none"), hold("off");
xlabel("Re(Z)");
ylabel("Im(Z)");
...
csvwrite("./blob/prbs_frf_latest.dat", mat);
