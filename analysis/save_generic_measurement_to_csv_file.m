% This script saves the measurement data points as real and imaginary numbers (2nd and 3rd column) to a CSV file. Frequency vector is written to the 1st column in Hertz.
...
fprintf("Estimation data is now written to '%s'!\n", csv_filepath);
